...
to go
  ...
  ask patches [
    ...
    ; check if the pache is alive or dead
    ifelse pcolor = green [
      ;; when alive
...
"" ""
PENS
"Alive" 1.0 0 -10899396 true "" "plot count patches with [pcolor = green]"
"Dead" 1.0 0 -1184463 true "" "plot count patches with [pcolor = yellow]"

@#$#@#$#@
### Value iteration al

This iis a hello tab.
